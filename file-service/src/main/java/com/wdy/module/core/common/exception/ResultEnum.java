package com.wdy.module.core.common.exception;
...
public enum ResultEnum implements AbstractBaseExceptionEnum {
    ...
    TAG_NOT_BIND_STYLES(40003, "标签未绑定样式"),
    TAG_EMPTY_STYLES(40004, "标签绑定样式中区域数量为0"),
    TAG_EMPTY_ROUTER(40005, "标签未绑定路由器"),
    TAG_BIND_GOOD_ROUTER_RUNNING(40006, "此路由器标签绑定商品操作进行中"),
    TAG_CHANGE_STYLE_ROUTER_RUNNING(40007, "此路由器标签更换样式操作进行中"),
    TAG_UPDATE_STYLES_ROUTER_RUNNING(40008, "此路由器标签改价或更新样式同步标签操作进行中"),
