...
public class SwaggerConfig {
    ...
    private List<ApiKey> securitySchemes() {
        ...
        apiKeyList.add(new ApiKey(ContextUtil.AUTHORIZATION, ContextUtil.AUTHORIZATION, "header"));
        return apiKeyList;
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("RONGHUI Doc")
                .description("RONGHUI Api文档")
                .termsOfServiceUrl("https://gitee.com/stylefeng/guns")
                .contact(new Contact("wdy", "https://gitee.com/stylefeng/guns", ""))
                .version("2.0")
                .build();
    }
